...
<body>
    ...
    <main>
        ...
        if (!$DB) {
            ...
            $getAllCommandes = mysqli_query($DB, $getAllCommandesRequest);

            $allCommandes = mysqli_fetch_all($getAllCommandes, MYSQLI_ASSOC);
            ...
            foreach ($allCommandes as $commande) {
                ...
                foreach ($commande as $commandeProperty => $commandePropertyValue) {
                    if (($commandeProperty != "id_commande") && ($commandeProperty != 'Id_Livre') && ($commandeProperty != 'Id_fournisseur')) {
                        $commandeLine .= "<td data-cellTitle='$commandeProperty'>" . $commandePropertyValue . "</td>";
                    }
                }
