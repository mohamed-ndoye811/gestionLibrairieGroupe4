<main>
    ...
    <form action="?controller=fournisseurs&action=confirmEdit" method="POST">
        <div>
            ...
            <input type="text" name="codeModifFour" id="codeModifFour" value="<?= $fournisseur['Code_fournisseur'] ?>"
                required>
        </div>
        ...
        <div>
            ...
            <input type="text" name="raisonModifFour" id="raisonModifFour"
                value="<?= stripslashes($fournisseur['Raison_sociale']) ?>" required>
        </div>

        <div>
            <label for="rueModifFour">Rue</label>
            <input type="text" name="rueModifFour" id="rueModifFour"
                value="<?= stripslashes($fournisseur['Rue_fournisseur']) ?>">
        </div>
        ...
        <div>
            ...
            <input type="text" name="villeModifFour" id="villeModifFour"
                value="<?= stripslashes($fournisseur['Localite']) ?>">
        </div>
